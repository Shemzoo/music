          ...
          <div class="p-6">
            ...
            <div
              class="w-full px-10 py-20 rounded text-center cursor-pointer border border-dashed
                ...
                @dragleave.prevent.stop="is_dragover = true"
  ...
  methods: {
    upload($event) {
      ...
      files.forEach((file) => {
        ...
        const storageRef = storage.ref(); // music-39e7b.appspot.com
        const songsRef = storageRef.child(`songs/${file.name}`); // music-39e7b.appspot.com/songs/example.mp3
